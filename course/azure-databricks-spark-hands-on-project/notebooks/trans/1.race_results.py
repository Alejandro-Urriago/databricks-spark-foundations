...
# MAGIC
# MAGIC SELECT 
# MAGIC a.race_id, count(*)
# MAGIC
# MAGIC FROM f1_presentation.race_results AS a
# MAGIC
# MAGIC GROUP by a.race_id
# MAGIC ORDER BY a.race_id DESC;
...
# MAGIC
# MAGIC SELECT 
# MAGIC a.file_date, COUNT(*) AS counting_records
# MAGIC FROM f1_presentation.race_results AS a
# MAGIC GROUP BY a.file_date
# MAGIC
# MAGIC
